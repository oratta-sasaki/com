...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("ComFrame", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
        glview = GLViewImpl::create("ComFrame");
#endif
    ...
    director->setAnimationInterval(1.0f / SYSTEM_FRAME_RATE);
	...
	//auto scene = BaseWindow::createScene();
